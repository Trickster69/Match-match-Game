...
export class VictoryModal {
  ...
  CloseBtn: HTMLElement;
    ...
    checkInputValue(element:HTMLElement | null) {
        ...
        if (!('indexedDB' in window)) {
            ...
            request.onsuccess = function() {
                ...
                (document.querySelector('form') as HTMLElement).addEventListener('submit',(e)=>{
                    e.preventDefault();
                    let name = document.querySelectorAll('.register-form__input')[0].value;
                    let surname = document.querySelectorAll('.register-form__input')[1].value;
                    let email = document.querySelectorAll('.register-form__input')[2].value;
